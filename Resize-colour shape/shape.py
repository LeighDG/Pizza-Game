...
class clsShapes():
    ...
    # Increases the size of the rectangle based on the size of the slider. Also updates the co-ords displayed in the label
    ...
    # Change the colour of the rectangle based on user choice
